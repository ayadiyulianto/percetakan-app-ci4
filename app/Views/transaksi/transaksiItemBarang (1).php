						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="idBarang" name="idBarang" class="form-control" placeholder="Id barang" maxlength="10" number="true" >
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="totalHarga" name="totalHarga" class="form-control" placeholder="Total harga" maxlength="10" number="true" required>
								</div>
							</div>
						</div>
