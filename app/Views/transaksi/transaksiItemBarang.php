						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" min="0" id="idBarang" name="idBarang" class="form-control" placeholder="Id barang" maxlength="10" number="true">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="namaBarang"> Nama barang: </label>
									<input type="text" id="namaBarang" name="namaBarang" class="form-control" placeholder="Nama barang" maxlength="255">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="satuanKecil"> Satuan kecil: </label>
									<input type="text" id="satuanKecil" name="satuanKecil" class="form-control" placeholder="Satuan kecil" maxlength="50">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" id="panjang" name="panjang" class="form-control" placeholder="Panjang">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label for="lebar"> Lebar: </label>
									<input type="text" id="lebar" name="lebar" class="form-control" placeholder="Lebar">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" min="0" id="totalHarga" name="totalHarga" class="form-control" placeholder="Total harga" maxlength="10" number="true" required>
								</div>
							</div>
						</div>
...
<script>
	$(function() {
		$('#data_table').DataTable({
			...
			"responsive": true,
			"ajax": {
				"url": '<?php echo base_url('transaksiItemBarang/getAll') ?>',
				"type": "POST",
				"dataType": "json",
				async: "true"
			}
	...
	function edit(id) {
		$.ajax({
			...
			success: function(response) {
				...
				$("#edit-form #panjang").val(response.panjang);
				$("#edit-form #lebar").val(response.lebar);
				$("#edit-form #jumlah").val(response.jumlah);
				$("#edit-form #harga").val(response.harga);
				$("#edit-form #totalHarga").val(response.total_harga);
