						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="idTransaksi" name="idTransaksi" class="form-control" placeholder="Id transaksi" maxlength="10" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="idBank" name="idBank" class="form-control" placeholder="Id bank" maxlength="10" number="true" >
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="number" id="jumlahDibayar" name="jumlahDibayar" class="form-control" placeholder="Jumlah dibayar" maxlength="10" number="true" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
