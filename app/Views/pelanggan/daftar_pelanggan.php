            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-form" class="pl-3 pr-3">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <input type="hidden" id="idPelanggan" name="idPelanggan" class="form-control" placeholder="Id pelanggan" maxlength="10" required>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="tipePelanggann"> Tipe pelanggan: <span class="text-danger">*</span> </label>
                                    <select id="tipePelanggann" name="tipePelanggan" class="form-control select2" style="width: 100%;" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="namaPelanggan"> Nama pelanggan: <span class="text-danger">*</span> </label>
                                    <input type="text" id="namaPelanggan" name="namaPelanggan" class="form-control" placeholder="Nama pelanggan" maxlength="255" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="noHp" name="noHp" class="form-control" placeholder="No HP" maxlength="50">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="alamat"> Alamat: </label>
                                    <input type="text" id="alamat" name="alamat" class="form-control" placeholder="Alamat" maxlength="255">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="perusahaan"> Perusahaan: </label>
                                    <input type="text" id="perusahaan" name="perusahaan" class="form-control" placeholder="Perusahaan" maxlength="255">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="modal-body">
                    <form id="edit-form" class="pl-3 pr-3">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="tipePelanggan"> Tipe pelanggan: <span class="text-danger">*</span> </label>
                                    <select id="tipePelanggan" name="tipePelanggan" class="form-control select2" style="width: 100%;" required>
                                        <option value="umum">Umum</option>
                                        <option value="agent">Agent</option>
                                    </select>
                                </div>
...
<script>
    $(function() {
        $('#data_table').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": '<?php echo base_url('pelanggan/getAll') ?>',
                "type": "POST",
                "dataType": "json",
                async: "true"
            }
    ...
    function add() {
        ...
        $.validator.setDefaults({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: '<?php echo base_url('pelanggan/add') ?>',
                    type: 'post',
    ...
    function edit(id_pelanggan) {
        $.ajax({
            url: '<?php echo base_url('pelanggan/getOne') ?>',
            type: 'post',
            data: {
            ...
            success: function(response) {
                ...
                $("#edit-form #tipePelanggan").val(response.tipe_pelanggan);
                ...
                $("#edit-form #perusahaan").val(response.perusahaan);
    ...
    function remove(id_pelanggan) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo base_url('pelanggan/remove') ?>',
                    type: 'post',
                    data: {
                        id_pelanggan: id_pelanggan
                    },
