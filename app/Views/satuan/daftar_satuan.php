            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-form" class="pl-3 pr-3">
                        <div class="row">
                            <input type="hidden" id="id" name="id" class="form-control" placeholder="Id" maxlength="2" required>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="namaSatuan"> Nama satuan: <span class="text-danger">*</span> </label>
                                    <input type="text" id="namaSatuan" name="namaSatuan" class="form-control" placeholder="Nama satuan" maxlength="50" required>
                                </div>
                            </div>
                        </div>
...
<script>
    $(function() {
        $('#data_table').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": '<?php echo base_url('satuan/getAll') ?>',
                "type": "POST",
                "dataType": "json",
                async: "true"
            }
    ...
    function add() {
        ...
        $.validator.setDefaults({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: '<?php echo base_url('satuan/add') ?>',
                    type: 'post',
    ...
    function edit(id) {
        $.ajax({
            url: '<?php echo base_url('satuan/getOne') ?>',
            type: 'post',
            data: {
                id: id
            },
    ...
    function remove(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: '<?php echo base_url('satuan/remove') ?>',
                    type: 'post',
                    data: {
                        id: id
                    },
